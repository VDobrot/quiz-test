export const data = {
  ...
  instructionsPage: {
    ...
    images: [
      {src: "https://picsum.photos/200", alt: "Step 1", text: "Step 1"},
      {src: "https://picsum.photos/200", alt: "Step 2", text: "Step 2"},
      {src: "https://picsum.photos/200", alt: "Step 3", text: "Step 3"}
    ],
  ...
  questionsPage: {
    questions: [
      {
        question: "How do you prefer to drink your Minute Maid?",
        answers: ["Answer 1", "Answer 2", "Answer 3"]
      },
      {
        question: "Which environment enhances your Minute Maid drinking experience?",
        answers: ["Answer 1", "Answer 2", "Answer 3"]
      },
      {
        question: "Which art style best captures the feeling of enjoying a Minute Maid?",
        answers: ["Answer 1", "Answer 2", "Answer 3"]
      },
    ],
    submitButton: "Submit",
